...
export async function ordersRoutes(fastify: FastifyInstance) {
    ...
    fastify.patch("/orders/:orderId/status", {...patchOrderUpdateStatus, preHandler: [authenticated]}, async (request, reply) => await orderController.updateStatus(request, reply));
